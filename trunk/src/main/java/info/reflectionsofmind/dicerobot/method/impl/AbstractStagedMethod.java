...
public abstract class AbstractStagedMethod<TConfig extends IRollConfig> extends AbstractRollingMethod {
	...
	public final void writeResult(final IDieRollerFactory factory, final IRollConfig config, final String input,
			final IFormattedBufferedOutput output) throws UserReadableException, FatalException {
